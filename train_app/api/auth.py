from train_app.db.models import UserProfile, RefreshToken
from train_app.db.schema import UserProfileSchema, UserLoginSchema
...
from train_app.config import (SECRET_KEY, ALGORITHM,
